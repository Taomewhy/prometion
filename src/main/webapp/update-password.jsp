            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/update-password" class="form-horizontal">
                       	<div class="row">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">原密码</label>
                                <div class="col-sm-3">
                                    <input name="originPassword" type="password" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="checkPassword" type="password" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<a href="/index_v148b2.jsp" class="btn btn-white">返回</a>
                                	</div>
                            </div>
                       </div>
                       </form>
